[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=8229371&assignment_repo_type=AssignmentRepo)
# Rede Social Gráfica
...
Poderia ser feito um tratamento de exceções, em que, quando inserido um identificador inválido, 
o programa emita um aviso ou peça ao usuário que tente outra vez. O método feed de notícias poderia ser alterado para, quando um id não é achado, retornar uma exceção em vez de simplesmente null. As vantagens estão em, não finalizar o programa durante a sua execução ou não produzir erros lógicos como resultado, além de deixar o código mais robusto. Dentre as desvantagens, é que essa abordagem possui algumas limitações, além de não ser tão simples de tratar a exceção em alguns casos.
