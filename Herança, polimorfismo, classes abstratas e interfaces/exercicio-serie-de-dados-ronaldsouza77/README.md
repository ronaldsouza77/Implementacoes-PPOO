[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=8207502&assignment_repo_type=AssignmentRepo)
# Séries de Dados
...
Porque o código foi desenvolvido seguindo a implementação das interfaces, pois elas separam completamente a definição de uma funcionalidade da sua implementação, podem ser vistas como contratos.

3. O que o polimorfismo tem a ver com o que foi feito?

A implementação de interfaces utiliza sobrescrita, ou seja, os métodos definidos na interface podem ter o comportamento alterado nas  subclasses. E, também, utiliza variável polimórfica, como a lista na classe ControladorSeriesClima, que é declarada com o tipo de uma interface mas possui objetos diferentes das subclasses.

4. Para que então servem as interfaces (como tipo de dado)?

Para maximizar os benefícios da utilização de Herança e Polimorfismo.
